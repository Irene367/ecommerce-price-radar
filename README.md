...
一句话价值：竞价雷达不是只帮你总结竞品变化，而是帮一人电商卖家判断：今天要不要跟价、怎么防守、先做哪几个动作。

它围绕“变化识别 → 风险判断 → 跟价建议 → 非价格防守 → 行动清单”形成稳定分析闭环。

适合淘宝、京东、拼多多、小红书等平台的一人店主或小团队。支持一句话、截图文字、竞品表格、公开链接等输入，输出风险等级、调价建议、毛利底线、非价格防守策略和今日行动清单。
...
- 新增一页版效果展示，帮助用户 30 秒看懂 Skill 价值。
- 新增使用前风险提示，明确不自动改价、不编造数据、链接失败时如何继续使用。
- 新增新手术语解释，降低电商运营新手理解成本。
- 新增多品类示例，覆盖服饰、食品、数码配件等典型场景。
- 优化 README 展示文案，突出“不是总结，而是给动作”。
